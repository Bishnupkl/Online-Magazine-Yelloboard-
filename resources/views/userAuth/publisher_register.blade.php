                            ...
                            <div class="container" style="width: 700px" >
                                ...
                                <div class=" row contact-wrap" >
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <a href="{{route('user.register')}}" class="btn btn-primary" style="width: 60%;height: 40px;font-size: large;float: right">Sign-Up</a>
                                            </div>
                                            <div class="col-lg-6">
                                        ...
                                        {!! Form::hidden('user_type', 'Publisher', [
                                                    'class' => 'common-input mb-20 form-control',
                                         ]) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 input-container {{$errors->has('companyname') ? 'has-error': ''}} ">
                                                <i class="fa fa-user icon"></i>
