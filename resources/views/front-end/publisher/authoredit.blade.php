...
@section('content')
    ...
    <div class="ibox-title col-lg-14 text-center" style="background: #7a43b6">
        <h3 style="color: #ffffff">Edit Author</h3>
    </div>
            ...
            <div class="ibox-content" style="background: #ffffff">
                <div class="row">
                    ...
                    {{--<div class="form-group col-lg-12">--}}
                        ...
                        {{--@if(isset($authordetail))--}}
                        {{--@foreach($authordetail->categories as $category_visitor)--}}
                        {{--@if($category_visitor->id == $cat->id)--}}
                        {{--checked--}}
                        {{--@endif--}}
                        {{--@endforeach--}}
                        {{--@endif--}}
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        @foreach($categories as $cat)
                            ...
                            @if(isset($authordetail))
                                @foreach($authordetail as $category_visitor)
                                    @if($category_visitor->id == $cat->id)
                                    checked
                                    @endif
                                @endforeach
