...
<div class="site-main-container">
    ...
    <section class="top-post-area pt-10">
        <div class="container no-padding">
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero-nav-area" style="background-image: url('{{asset('assets/admin/img/'.$cat->image)}}');
            ...
            <div class="row">
                <div class="col-lg-8 post-list">
                    ...
                    <div class="latest-post-wrap">
                        ...
                        <div id="loop-2">
                        @foreach($data['posts']->slice(0,2) as $p)
                        @if($p !== null)
                        ...
                        <div class="load-more">
                            <a href="#" class="primary-btn" id="load-more">Load More Posts</a>
                        </div>
                    ...
                    <div class="sidebars-area">
                        <div class="single-sidebar-widget editors-pick-widget">
                            ...
                            <div class="single-sidebar-widget most-popular-widget">
                                ...
                                @foreach($mostpopularcategory as $mpc)

                                    <div class="single-list flex-row d-flex">
                                        <div class="thumb">
                                            <img src="{{asset('assets/admin/img/'.$mpc->image)}}" alt="" width="100px" height="100px">
                                        </div>
                                        <div class="details">
                                            <a href="{{route('postdetail.index',$mpc->id)}}">
                                                <h6>{{$mpc->title}}</h6>
                                            </a>
                                            <ul class="meta">
                                                <li>
                                                    ...
                                                    @if($mpc->visitor_id != 0)
                                                        <a href="{{route('about_uploader.index',\App\Visitor::find($mpc->visitor_id)->email)}}"><span class="lnr lnr-user"></span>
                                                            {{\App\Visitor::find($mpc->visitor_id)->name}}
                                                        </a>

                                                    @else
                                                        <a href="{{route('about_uploader.index',\App\User::find($mpc->user_id)->email)}}"><span class="lnr lnr-user"></span>
                                                            {{\App\User::find($mpc->user_id)->name}}
                                                        </a>
                                                    @endif

                                                </li>
                                                <li><a href="#"><span class="lnr lnr-calendar-full"></span>{{$mpc->created_at->diffForHumans()}}</a></li>
                                                <li><a href="#"><span class="lnr lnr-eye"></span>{{$mpc->view_count}}</a></li>
