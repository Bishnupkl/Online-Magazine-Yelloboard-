                            ...
                            <div class="container"  >
                                ...
                                <div class=" row contact-wrap" >
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <a href="{{route('front.user.signup')}}" class="btn btn-primary" style="width: 60%;height: 40px;font-size: large;float: right">Publisher Sign-Up</a>
                                            </div>
                                            <div class="col-lg-6">
