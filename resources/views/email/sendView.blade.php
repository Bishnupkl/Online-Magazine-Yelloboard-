...
{{--You have successfully registered to YelloBoard.--}}
    {{--<p>To verify your email please the click link below.<br><a href="{{route('sendEmailDone',["email"=>$user->email,"verification_key"=>$user->verification_key])}}"> click here</a></p>--}}
                ...
                <tr>
                    ...
                    <td align="center" valign="top" style="background: #ffffff;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                            <tr>
                                <td align="center" valign="top">
                                    ...
                                    <a href="#"
                                       style="display: block; max-width: 192px; text-decoration: none;">
                                        <h1 width="192"
                                            border="0" style="display: block; width: 192px; font-size: 50px;"><strong>YelloBoard</strong></h1>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                            <tr>
                              ...
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px;">
                                  ...
                                  <h3>It's time to confirm your email address.</h3>

                                  We received a request to set your YelloBoard email to {{$user->email}}.
                                If this is correct, please confirm by clicking the button below.
                                    ...
                                    <table class="mob_btn" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tr>
                                            <td align="center" valign="top">
                                                <a href="{{route('sendEmailDone',["email"=>$user->email,"verification_key"=>$user->verification_key])}}"
                            ...
                            <tr>
                                <td align="left" valign="top"> <font face="'Source Sans Pro', sans-serif" color="#7f7f7f" style="font-size: 17px; line-height: 23px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #7f7f7f; font-size: 17px; line-height: 23px;">
                                            Once you confirm, all future messages about your YelloBoard account will be sent to {{$user->email}}.</span>
                                    </font>
                        ...
                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #868686; font-size: 15px; line-height: 20px;">
                           YelloBoard
                           <br>
                           Sahayoginagar, Kathmandu, Nepal</span>
                                                </font>
